...
export const Navbar1 = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full transition-all duration-300 bg-gray-900 border-b shadow-lg z-100 bg-opacity-90 backdrop-blur-md border-emerald-800">
