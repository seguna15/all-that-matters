...
const CustomerOrderDetails = () => {
  const { id } = useParams();
  const { order, isLoading, getOrder } = useOrdersStore();
              ...
              <div className="max-w-3xl mx-auto">
                <div className="max-w-xl">
                  ...
                  <p className="mt-2 text-base text-gray-500 dark:text-gray-100">
                    Your order {order?.paymentSessionID} is {order?.orderStatus}{" "}
                    ...
                    >
                      ...
                      <div className="flex flex-col flex-auto">
                        ...
                        <div className="flex items-end flex-1 mt-6">
                          <dl className="flex flex-wrap space-x-4 text-sm divide-x divide-gray-200 sm:space-x-6">
                            <div className="flex">
                            ...
                            <div className="flex pl-4 sm:pl-6">
                              ...
                              <dd className="ml-2 text-gray-700 dark:text-gray-100">
                                &#8358;
                                {(
                                  orderItem?.boughtQty * orderItem?.price
                                )?.toFixed(2)}
                              </dd>
                            </div>
                          </dl>
